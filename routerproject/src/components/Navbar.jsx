...
const Navbar = (props) => {
  ...
  return (
    <div className="flex justify-between items-center w-11/12 max-w-[1160px] py-4 mx-auto">
      ...
      <nav>
        <ul className="flex gap-x-6 text-amber-50">
          <li>
            <Link to="/">Home</Link>
          </li>
          <li>
      ...
      <div className="flex items-center gap-x-4 text-amber-50 ">
        {!isLoggedIn && (
          <Link to="/login">
            <button className="bg-richblack-800 py-[8px] px-[12px] cursor-pointer rounded-[8px] border border-richblack-700">
              Login
            </button>
          </Link>
        )}
